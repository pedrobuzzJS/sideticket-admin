...
import { Route as ListIconRouteImport } from './pages/list/icon'
...
const ListIconRoute = ListIconRouteImport.update({
  id: '/list/icon',
  path: '/list/icon',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/list/icon': typeof ListIconRoute
...
export interface RootRouteChildren {
  ...
  ListIconRoute: typeof ListIconRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/list/icon': {
      ...
      path: '/list/icon'
      fullPath: '/list/icon'
      preLoaderRoute: typeof ListIconRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/list/form': {
      id: '/list/form'
